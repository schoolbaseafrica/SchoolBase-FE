...
export function ClassroomCard({
  ...
  // Use classroom.is_available, defaulting to true if undefined (for backward compatibility)
  const [localAvailability, setLocalAvailability] = useState(
    classroom.is_available !== undefined ? classroom.is_available : true
  )

  const handleToggleAvailability = async () => {
    const newAvailability = !localAvailability
    setLocalAvailability(newAvailability)
    // Call the parent's toggle function to update the backend
